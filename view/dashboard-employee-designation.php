									...
									<form id="myForm"  class="wt-formtheme wt-formprojectinfo wt-formcategory">
										<fieldset>
											<div class="form-group">
												<input id="desig" type="text" name="designation" class="form-control" placeholder="Employee Designation">
											</div>
											<div class="form-group form-group-label">
												...
												<div class="wt-labelgroup">
													...
													<input id="file"  type="file" name="file_icon" >
													</label><br>
											...
											<div class="form-group wt-btnarea">
												<input  type="submit" name="employee" value="Add New Designation" class="wt-btn btn btn-lg">
							...
							<div class="wt-dashboardbox wt-categorys">
								...
								<div class="wt-dashboardboxcontent wt-categoriescontentholder">
									<table class="wt-tablecategories">
										...
										<tbody>
											<?php foreach($designation_data as $value){?>
											<tr>
												<td>
										...
										<?php } ?>
											<!-- <tr>
												<td><figure><img src="images/icons/moderator.png" alt="img description"></figure></td>
												<td>Moderator</td>
												<td>
													<div class="wt-actionbtn">
														<a href="dashboard-manange-access.php" class="wt-addinfo wt-skillsaddinfo"><i class="lnr lnr-pencil"></i></a>
											...
											<tr>
												<td><figure><img src="images/icons/controller.png" alt="img description"></figure></td>
												<td>Controller</td>
												<td>
													<div class="wt-actionbtn">
														<a href="dashboard-manange-access.php" class="wt-addinfo wt-skillsaddinfo"><i class="lnr lnr-pencil"></i></a>
  ...
  $("#myForm").on('submit',function (event) {
    ...
    $.ajax({
      ...
      success:function(data){
      	window.location.href = 'employee-designation';
      }
    })
